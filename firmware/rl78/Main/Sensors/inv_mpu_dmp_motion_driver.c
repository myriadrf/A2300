...
#include "Main.h"
#include "Timers.h"		// Loctronix.
/* delay_ms is a function already defined in ASF. */
#define get_ms(A)   Timer_GetTime(A)
#define log_i       MPL_LOGI
#define log_e       MPL_LOGE
#else
...
#define GYRO_SF             (46850825 * 200 / DMP_SAMPLE_RATE)
...
int dmp_set_accel_bias(long *bias)
{
    ...
    float accel_sf; // CJC long long accel_sf;
    unsigned short accel_sens;

    mpu_get_accel_sens(&accel_sens);
    accel_sf = accel_sens * 32768.f; // CJC (long long)accel_sens << 15;
    NOP(); // __no_operation();
...
int dmp_set_shake_reject_time(unsigned short time)
{
    ...
    tmp[0] = (unsigned char) (time >> 8);
    tmp[1] = (unsigned char) (time & 0xFF);
