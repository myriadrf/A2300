...
int UHD_SAFE_MAIN(int argc, char *argv[]){
	...
	// Force library open.
	printf("Force library loading...");

	// CJC: I don't think we need this.
	if( dlopen( "/home/chris/Projects/gnuradio/src/uhd/host/build/lib/libuhd.so", RTLD_LAZY) == NULL)
	{
		printf("Failed 2");
	}

	if( dlopen( "/home/chris/Projects/WksAsr2300/pkgs/OpenSource/host/lib/UhdAdaptor/Debug/libUhdAdaptor.so", RTLD_LAZY) == NULL)
	{
		printf("FAILED, BUMMER.");
	}
