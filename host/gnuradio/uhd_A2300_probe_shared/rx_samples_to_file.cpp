...
int UHD_SAFE_MAIN(int argc, char *argv[]){
    ...
    desc.add_options()
        ...
        ("freq", po::value<double>(&freq)->default_value(2400e6), "RF center frequency in Hz")
        ("gain", po::value<double>(&gain), "gain for the RF chain")
        ("ant", po::value<std::string>(&ant)->default_value("L1GpsExt"), "daughterboard antenna selection")
